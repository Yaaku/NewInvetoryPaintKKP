...
import { compactRupiah } from "@/lib/dashboard-metrics";
...
/** Full operational dashboard — shown to Admin Gudang. */
export default async function AdminDashboard({ title }: { title: string }) {
  const now = new Date();
